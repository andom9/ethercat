...
// TODO: できてない
//    fn check_eeprom_info(&mut self) -> Result<(), Error> {
...
//        //    return Err(Error::CannotAccessEEPROM);
//        //}
//
//        //EEPROMリードコマンドの送信
...
//                != 0;
//            if is_eeprom_error {
//                return Err(Error::EEPROMStatusError);
//            }
//        }
//
//        //ベンダーIDのリード
...
//        self.send_packet_with_error_read()?;
//        EtherCATFrame::new(self.recieve_packet_with_error_check(1000_000_000)?)?;
//
...
//    }
//
//    fn is_eeprom_busy(&mut self) -> Result<bool, Error> {
...
//    }
//
//    fn wait_eeprom_busy(&mut self, timeout_mills: u64) -> Result<(), Error> {
//        let now = std::time::Instant::now();
//        let timeout = std::time::Duration::from_millis(timeout_mills);
//        while self.is_eeprom_busy()? {
//            if now.elapsed() >= timeout {
//                return Err(Error::EEPROMBusyTimeout);
//            }
